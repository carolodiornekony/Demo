define("frmBizCardCamera", function() {
    return function(controller) {
        function addWidgetsfrmBizCardCamera() {
            ...
            var lblScanOrEnter = new kony.ui.Label({
                ...
                "text": "Centre your card and we'll scan it automatically",
                "top": "2%",
                "width": "56%",
                "zIndex": 1
            }, {
            ...
            flxSignUp1.add(lblScanOrEnter, imgCapture);
            flxMain.add(flxHeader, flxSignUp1);
            this.add(flxMain);
        };
        return [{
            "addWidgets": addWidgetsfrmBizCardCamera,
